...
export const registerSchemaValidation = yup.object().shape({
    ...
    lastName: yup
        ...
        .min(2, 'Minimum of 2 characters')
        .max(50, 'Maximum of 50 characters')
        .matches(ONLY_LETTERS_REGEX, 'Last name must contain only letters'),
    email: yup.string().email('Invalid email address').required('Required'),
    expertise: yup
        .string()
        .required('Required')
        .min(4, 'Minimum of 4 characters')
        .matches(ONLY_LETTERS_REGEX, 'Expertise must contain only letters'),
    city: yup
        .string()
        .required('Required')
        .min(3, 'Minimum of 3 characters')
        .matches(ONLY_LETTERS_REGEX, 'City must contain only letters'),
    password: yup
        .string()
        .required('Required')
...
export const createSchoolSchemaValidation = yup.object().shape({
    name: yup
        ...
        .matches(ONLY_LETTERS_REGEX, 'Name must contain only letters'),
    image: yup
    ...
    street: yup
        ...
        .min(3, 'Minimum of 3 characters')
        .max(15, 'Maximum of 15 characters')
        .matches(ONLY_LETTERS_REGEX, 'Street must contain only letters'),
    ...
    description: yup
        ...
        .matches(ONLY_LETTERS_REGEX, 'Description must contain only letters'),
});
...
export const editUserModalRightSchema = yup.object().shape({
    firstName: yup
        ...
        .min(3, 'Minimum of 3 characters')
        .max(50, 'Maximum of 50 characters')
        .matches(ONLY_LETTERS_REGEX, 'First name must contain only letters'),
    lastName: yup
        .string()
        .required('Required')
        .min(3, 'Minimum of 3 characters')
