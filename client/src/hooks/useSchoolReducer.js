...
export const useSingleSchoolReducer = () => {
  ...
  const singleSchoolMethods = {
    ...
    setSingleSchool: (school, isLiked) => {
      dispatch({ type: singleSchoolActions.SET_SINGLE_SCHOOL, payload: { school, isLiked } });
    },
    /**
    ...
    removeFeedback: feedbackId => {
      dispatch({ type: singleSchoolActions.REMOVE_FEEDBACK, payload: feedbackId });
    },
    /**
    ...
    updateFeedback: (id, data) => {
      dispatch({ type: singleSchoolActions.UPDATE_FEEDBACK, payload: { feedbackId: id, data } });
    },
  };
