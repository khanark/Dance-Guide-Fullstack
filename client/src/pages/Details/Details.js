...
const Details = () => {
    ...
    const { singleSchool, updateSchool } = schoolsFactory(user);
        ...
        <div className="details-page container-secondary">
                    ...
                    <>
                        ...
                        <div className="school-details--wrapper">
                                ...
                                {user && isUserOwnSchool && (
                                    <div className="school-user__action">
                                        <EditSchoolModal
                                            ...
                                            updateSchoolState={
                                                schoolActions.updateSingleSchool
                                            }
                                            {...school}
                                        />
                                    </div>
                            ...
                            <h5 className="school-general-info">
                                Publicated on {formatDate(school?.createdAt)}{' '}
                                from{' '}
                                <Link
            ...
            {!isLoading && (
                <section className="school-feedbacks section">
                    ...
                    {user &&
                        !isUserOwnSchool &&
                        school?.feedbacks?.some(
                            (fb) => fb.owner._id !== user._id
                        ) && (
