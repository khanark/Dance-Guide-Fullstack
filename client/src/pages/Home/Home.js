        ...
        <div className="home-page">
            <section className="hero container section">
                <h1 className="title-primary">
                    Your <span>ultimate</span> resource for dance schools in
                    your area!
                </h1>
                <h5 className="desc text-shadow">
                    With DanceGuide, you can easily search for dance schools by
                    location, dance style, and even instructor. Our
                    user-friendly interface makes it easy to find the
                    information you need quickly, so you can get back to what
                    you love - dancing.
                </h5>
                <div className="customers-wrapper">
                    ...
                    <h4 className="customer-description text-shadow">
                        Over <span>250,000+</span> people already found their
                        passion!
                    </h4>
                </div>
